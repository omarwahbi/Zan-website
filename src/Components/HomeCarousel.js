        ...
        <div className="col-md-8 d-flex mt-4">
          <div className="row d-md-none">
            <div className="col-md-6 justify-content-center d-flex">
              <Link className="category-link" to={"projects/windows"}>
                <img
            ...
            <div className="col-md-6 justify-content-center d-flex">
              <Link className="category-link" to={"projects/indoor"}>
                <img
                  alt="indoor doors"
                  src={indoorImageUrl}
                  className="m-0 menu-item-img category-scale"
          ...
          <div className="row d-md-none">
            <div className="col-md-6 justify-content-center d-flex">
              <Link className="category-link" to={"projects/outdoor"}>
                <img
                  alt="outdoor doors"
                  src={outdoorImageUrl}
                  className="m-0 menu-item-img category-scale"
            ...
            <div className="col-md-6 justify-content-center d-flex">
              <Link className="category-link" to={"projects/gates"}>
                <img
                  alt="gate doors"
                  src={gateImageUrl}
                  className="m-0 menu-item-img category-scale"
          ...
          <div className="col-md-3 d-none d-md-flex mt-5">
            <Link to={"projects/windows"}>
              <img
                alt="Aluminum windows"
                src={windowsImageUrl}
                className="m-0 menu-item-img category-scale"
...
//           </div>
//         </div>
//         <div className="col-md-8 d-flex flex-wrap mt-4">
//           <div className="row">
//             <div className="col-md-6 justify-content-center d-flex">
//               <Link className="category-link" to={"projects/indoor"}>
//                 <img
